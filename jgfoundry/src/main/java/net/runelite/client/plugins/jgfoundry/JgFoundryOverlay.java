...
@Slf4j
@Singleton
class JgFoundryOverlay extends OverlayPanel
{
    private final JgFoundryPlugin plugin;
    private final JgFoundryConfig config;

    String timeFormat;

    @Inject
    private JgFoundryOverlay(final Client client, final JgFoundryPlugin plugin, final JgFoundryConfig config)
    {
        super(plugin);
